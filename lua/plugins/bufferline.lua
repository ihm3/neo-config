...
--           end,
            ...
            --get_element_icon = function(element)
              ...
              -- e.g.
              --local icon = require('nvim-web-devicons').get_icon_by_filetype(element.filetype, { default = false })
            ...
            separator_style = "slant",--{'slope', 'slant'},-- "slant" | "slope" | "thick" | "thin" | { 'any', 'any' },
